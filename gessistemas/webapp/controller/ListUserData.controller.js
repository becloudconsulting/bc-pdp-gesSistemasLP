sap.ui.define([
     ...
     */
    function (Controller, Filter, MessageBox, JSONModel, Spreadsheet, MessageToast, exportLibrary,TreeTable) {
        "use strict";
        ...
        return Controller.extend("com.becloud.pdp.gessistemas.controller.ListUserData", {
            ...
            updateFinished: function (oEvent) {
                ...
                this.getView().byId("idListUsersData").setText("Registros (" + total + ") -  Sistema correspondiente");
            },
